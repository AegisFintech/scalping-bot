-- Preserve historical Astra rows and permit the operator-selected exact Sol route.
-- Runtime consumers still require the active release pin; no context data is rewritten.
...
ALTER TABLE scenario_contexts ADD CONSTRAINT scenario_contexts_requested_model_check
  CHECK (requested_model IN ('gpt-6-astra/u64', 'gpt-5.6-sol/u40')) NOT VALID;
