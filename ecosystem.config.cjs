...
function service(name, overrides = {}) {
  return {
    ...
    env: {
      NODE_ENV: "production",
      APP_ENV: "production",
      STRATEGY_VERSION: "0.1.0-actionable-oco-auto-demo.33",
      CODE_VERSION: "0.1.0-actionable-oco-auto-demo.33",
      AUTOMATIC_ANALYSIS_COMPLETED_LIMIT: "500",
      AUTOMATIC_ANALYSIS_COMPLETED_BASELINE: "105",
      AUTOMATIC_DEMO_CLOSED_TRADE_LIMIT: "100",
      AUTOMATIC_DEMO_CLOSED_TRADE_BASELINE: "49",
