...
times that TP distance. effective_risk_reward_ratio is therefore reward/risk=0.5. Your first
directional target must be at or beyond that nearer effective TP, and your stop/invalidation must be
at or beyond that nearer effective SL. Do not calculate commission, volume, position size, or
substitute another ratio; the service independently recomputes all of it at minimum and final volume.
