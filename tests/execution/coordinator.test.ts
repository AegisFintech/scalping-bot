  ...
  it("derives exact tick-aligned entry, stop, and expiry bounds for the model", () => {
    expect(
      deriveModelExecutionBounds({
        ...
        atr: "1",
        maxEntryDistanceAtr: "2.5",
        entryLatencyBufferAtr: "0.25",
        preferredMaxEntryDistanceAtr: "0.75",
        maxStopDistanceAtr: "3",
      ...
      buyPreferredEntryMinimum: "2000.35",
      buyPreferredEntryMaximum: "2000.85",
      sellPreferredEntryMinimum: "1999.15",
      sellPreferredEntryMaximum: "1999.65",
      entryLatencyBufferAtr: "0.25",
      preferredMaxEntryDistanceAtr: "0.75",
      minimumStopDistance: "0.1",
